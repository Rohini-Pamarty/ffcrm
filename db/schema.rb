...
ActiveRecord::Schema.define(:version => 20110806095210) do
  ...
  add_index "projects", ["assigned_to"], :name => "index_projects_on_assigned_to"
  add_index "projects", ["user_id", "name", "deleted_at"], :name => "index_projects_on_user_id_and_name_and_deleted_at", :unique => true
